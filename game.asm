...
.model small
.stack 150h
;INTERRUPCION 80h / instalar archivo limpiar.asm
...
;VARIABLES EN DONDE SE GUARDAN EL VALOR DE LAS CARTAS
...
;pido una carta
    ...
    add ncar, 4
;-----------------------------
;obtengo el valor de la CARTA JUGADOR NRO #1
    lea si, carta
    lea bx, user_carta_1
    call muevoValor
;-----------------------------
;GENERO  CARTA JUGADOR NRO #2
    call salto
    xor dx, dx
    mov dl, ncar
    lea si, cartas
